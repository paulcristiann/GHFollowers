    ...
    func getFollowers(username: String, page: Int) {
        ...
        NetworkManager.shared.getFollowers(for: username, page: page) { [weak self] result in
            ...
            case .failure(let errorMessage):
                self.presentGFAlertOnMainThread(title: "Network error", message: errorMessage.rawValue, buttonTitle: "Ok")
            }
        }
    }
            ...
            case .success(let user):
                ...
                PersistanceManager.updateWith(favourite: favourite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentGFAlertOnMainThread(title: "Success!", message: "Favourited the user!", buttonTitle: "Ok")
                        return
                    }
